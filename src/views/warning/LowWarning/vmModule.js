...
export default {
    ...
    methods: {
        ...
        funcGetWarningData(){
            ...
            var url = warning.DetialRequest.Low + '?shopCode=' + localStorage.getItem("shopCode") + '&searchShop=' + this.searchForm.companyCode + 
        ...
        eventExport(){
            ...
            var url_1 = warning.DetialRequest.LowExport + "?searchShop=" + this.searchForm.companyCode + "&shopCode=" + localStorage.getItem("shopCode")
    ...
    mounted() {
        ...
        this.permissionsList = AllPromossions.find(function (item) { return item.ModuleUrl == 'MinStockWarn' }).Rights;
