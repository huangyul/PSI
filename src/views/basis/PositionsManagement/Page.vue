<template>
    <div class="all">
        <div class="topBtnBox">
					<button v-show="permissionsList.Add" class="green" @click="eventOpenWindow()"><i class="el-icon-plus"></i>新增仓位</button>
				...
				<div class="searchBox">
					<div class="conditions">
						...
						<div class="box">
							<span>关联仓库</span>
							<div class="inputBox">
								<el-select v-model="searchForm.whCode" clearable filterable placeholder="请先选择门店">
									<el-option :label="item.Name" :value="item.Code" v-for="item in WarehouseList" :key="item.Code"></el-option>
								</el-select>
							</div>
						</div>
						<div class="box">
				...
				<div class="middle">
					<el-table border stripe ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" height="100%" @selection-change="eventTableSelect" :row-class-name="funcRowClassName">
					  <!-- <el-table-column type="selection" width="55" align="center"> </el-table-column> -->
						<el-table-column prop="Code" label="仓位编号">
						...
						<el-table-column prop="Name" label="仓位名称"> </el-table-column>
						<el-table-column prop="WarehouseName" label="关联仓位名称"> </el-table-column>
					</el-table>
				</div>
				<div class="footer">
					<el-pagination
				...
				<el-dialog :title="OpenWindowTitle" v-model="dialogVisible" width="800px">
				  <div>
						<div class="addBox">
							<div class="childBox">
								<span><span class="requiredTip">*</span>仓位名称：</span>
								<div class="regular">
						...
						<div class="addBox">
							<div class="childBox">
								<span><span class="requiredTip">*</span>关联仓库：</span>
								<div class="regular">
									<el-select v-model="addForm.WarehouseCode" filterable placeholder="请先选择门店" :disabled="isUpdate_1">
										<el-option :label="item.Name" :value="item.Code" v-for="item in WarehouseList_2" :key="item.Code"></el-option>
									</el-select>
								</div>							
							</div>
							<div class="childBox">
								...
								<div class="regular">
									<el-select v-model="addForm.ShopCode" clearable filterable :disabled="isUpdate_1">
										<el-option :label="item.Name" :value="item.Code" v-for="item in shopList" :key="item.Code"></el-option>
									</el-select>
								</div>							
							</div>
