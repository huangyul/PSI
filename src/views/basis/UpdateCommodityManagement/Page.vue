      ...
      <div class="formBox">
        ...
        >
          ...
          <el-form-item label="商品编号:" required>
            <div class="large" style="width: 600px">
              <el-input v-model="form.Mat_No" :disabled="true"></el-input>
            </div>
          </el-form-item>
          ...
          <el-form-item label="商品主图:">
            <div class="uploadImgBox">
              <div
                class="imgBox"
                v-for="item in form.item_Photos"
                :key="item.Photo"
              >
                <i @click="eventOldImgDetele(item)" style="">×</i>
                <el-image
                  :src="item.Photo"
                  fit="fill"
          ...
          <el-form-item label="条形码类别:">
            <el-radio-group v-model="ProductBarCodes.BarCodeType">
