      ...
      >
        ...
        <el-table-column prop="PlanCode" label="采购计划编号" min-width="180">
          <template #default="scope">
            ...
            <span v-show="!permissionsList.Edit">{{ scope.row.PlanCode }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="Status" label="计划状态" min-width="80">
          <template #default="scope">
            <span v-if="scope.row.Status == 0" class="StatusYellow"
              >待处理</span
            >
            <span v-if="scope.row.Status == 1" class="StatusGreen">处理中</span>
            <span v-if="scope.row.Status == 5" class="StatusGray">已下单</span>
          </template>
        </el-table-column>
        <el-table-column
